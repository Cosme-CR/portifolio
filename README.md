...
* **Tailwind CSS** (Estilização via utilitários, cores customizadas, grids e animações)
...
* **Responsive-First:** Layout totalmente adaptável para mobile, tablets e desktops utilizando Flexbox e CSS Grid do Tailwind.
* **Seções Integradas:**
    * `~ /home/cosme`: Apresentação com overview de OS/WM/Editor (estilo Neofetch).
    * `[ Stacks ]`: Hard skills categorizadas.
    * `[ Projetos ]`: Showcase com descrições objetivas e links para repositórios.
    * `[ Educação ]`: Background acadêmico (Engenharia de Computação, Eletrônica).
